...
from Pretrained_ResNet import generate_model
...
tub_path=data_path('/IDH/IDH_tub')
tub_dataset=[]
tub_labelset=[]
for idx,tub_patient in enumerate(tub_path):
    ...
    for modal in range(len(tub_patient)-1):
        if modal==0:
            data_1,data_2,data_3,data_4,data_5=class_.normalize(modal=modal+1)
        else:
            data_1_,data_2_,data_3_,data_4_,data_5_=class_.normalize(modal=modal+1)
            data_1=np.concatenate((data_1,data_1_),axis=0)
            data_2=np.concatenate((data_2,data_2_),axis=0)
            data_3=np.concatenate((data_3,data_3_),axis=0)
            data_4=np.concatenate((data_4,data_4_),axis=0)
            data_5=np.concatenate((data_5,data_5_),axis=0)                     
                                  
    label=class_.generate_labelset()
    tub_dataset.append(data_1)
    tub_dataset.append(data_2)
    tub_dataset.append(data_3)
    tub_dataset.append(data_4)
    tub_dataset.append(data_5)
...
yes_path=data_path('/IDH/IDH_yes')
yes_dataset=[]
yes_labelset=[]
for idx,yes_patient in enumerate(yes_path):
    ...
    label=class_.generate_labelset()
    yes_dataset.append(data_1)
    yes_dataset.append(data_2)
    yes_dataset.append(data_3)
    yes_dataset.append(data_4)
    yes_dataset.append(data_5)
...
optimizer=optim.Adam(model.parameters(),lr=1e-5,betas=sets.betas,weight_decay=3e-4)
...
def train(epoch):
    ...
    print('--------------------------------------------') 
    print('IDH_Fold1:Train Epoch:{}-->Loss:{:6f}-->ACC:{:6f}-->SN:{:6f}-->SP:{:6f}-->PPV:{:6f}-->NPV:{:6f}-->AUC:{:6f}'
...
def test(epoch):
    ...
    print('--------------------------------------------') 
    print('IDH_Fold1:Test Epoch:{}-->Loss:{:6f}-->ACC:{:6f}-->SN:{:6f}-->SP:{:6f}-->PPV:{:6f}-->NPV:{:6f}-->AUC:{:6f}'
