...
def train(epoch):
    ...
    print('--------------------------------------------') 
    print('LGG&&GBM_Fold5:Train Epoch:{}-->Loss:{:6f}-->ACC:{:6f}-->SN:{:6f}-->SP:{:6f}-->PPV:{:6f}-->NPV:{:6f}-->AUC:{:6f}'
...
def test(epoch):
    ...
    print('--------------------------------------------') 
    print('LGG&&GBM_Fold5:Test Epoch:{}-->Loss:{:6f}-->ACC:{:6f}-->SN:{:6f}-->SP:{:6f}-->PPV:{:6f}-->NPV:{:6f}-->AUC:{:6f}'
