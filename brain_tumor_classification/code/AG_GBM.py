...
yes_path=data_path('/grade/GBM_4')
yes_dataset=[]
yes_labelset=[]
...
optimizer=optim.Adam(model.parameters(),lr=1e-4,betas=sets.betas,weight_decay=3e-4)
...
def train(epoch):
    ...
    print('--------------------------------------------') 
    print('AG&&GBM_Fold5:Train Epoch:{}-->Loss:{:6f}-->ACC:{:6f}-->SN:{:6f}-->SP:{:6f}-->PPV:{:6f}-->NPV:{:6f}-->AUC:{:6f}'
...
def test(epoch):
    ...
    print('--------------------------------------------') 
    print('AG&&GBM_Fold5:Test Epoch:{}-->Loss:{:6f}-->ACC:{:6f}-->SN:{:6f}-->SP:{:6f}-->PPV:{:6f}-->NPV:{:6f}-->AUC:{:6f}'
